...
void print_vec(const string name, const vector<TYP>& v){
    cout << name << endl;
    for (const TYP& item : v) cout <<item<<" ";
    cout << endl;
}
 ...
 * */
template <typename TYP>
void print_list(const string name,const list<TYP>& l){
    cout << name<<endl;
    for (const TYP& item : l) cout<<item<<" ";
    cout<<endl;
}
...
template <typename TYP>
void print(const string name, const TYP& stuff) {
    cout <<name<<endl;
    for (auto item : stuff) cout<<item<<" ";
    cout<<endl;
}
...
int main() {
     ...
     * */
    int ilen = 8;
    int iptr[] = { 161, 32, 64, 128, 21, 3, 8, 17 };
   ...
   print("ilist sorted：", ilist);
    ...
    odd_iter++;
    cout << "The second odd number in ilist is: "<<*odd_iter<<endl;
    /*
